package com.example.mapbaidu.map.mvp.ui.activity;
...
import com.example.mapbaidu.R;
import com.example.mapbaidu.map.base.App;
import com.example.mapbaidu.map.base.BaseActivity;
import com.example.mapbaidu.map.base.BasePresenter;
import com.example.mapbaidu.map.engine.adapter.HomeActVpAdapter;
import com.example.mapbaidu.map.manager.ContainManager;
import com.example.mapbaidu.map.manager.ThreadPoolManager;
import com.example.mapbaidu.map.mvp.ui.fragment.CollectFragment;
import com.example.mapbaidu.map.mvp.ui.fragment.HomeFragment;
