...
package com.example.baidudituxiangmu.clusterutil.clustering.view;
...
import com.example.baidudituxiangmu.R;
import com.example.baidudituxiangmu.clusterutil.MarkerManager;
import com.example.baidudituxiangmu.clusterutil.clustering.Cluster;
...
import com.example.baidudituxiangmu.clusterutil.projection.Point;
import com.example.baidudituxiangmu.clusterutil.projection.SphericalMercatorProjection;
import com.example.baidudituxiangmu.clusterutil.ui.IconGenerator;
import com.example.baidudituxiangmu.clusterutil.ui.SquareTextView;
...
import static com.example.baidudituxiangmu.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
    ...
    private View makeSquareTextView(Context context) {
