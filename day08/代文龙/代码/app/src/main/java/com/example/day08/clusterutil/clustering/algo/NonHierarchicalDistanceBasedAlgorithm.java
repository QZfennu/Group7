...
package com.example.day08.clusterutil.clustering.algo;
...
import com.example.day08.clusterutil.projection.Bounds;
...
import com.example.day08.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.example.day08.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.example.day08.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.example.day08.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.example.day08.clusterutil.clustering.algo
