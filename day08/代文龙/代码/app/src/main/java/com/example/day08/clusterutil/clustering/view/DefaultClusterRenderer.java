...
package com.example.day08.clusterutil.clustering.view;
...
import com.example.day08.clusterutil.MarkerManager;
import com.example.day08.clusterutil.clustering.Cluster;
...
import com.example.day08.clusterutil.projection.Point;
import com.example.day08.clusterutil.projection.SphericalMercatorProjection;
import com.example.day08.clusterutil.ui.IconGenerator;
...
import static com.example.day08.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        com.example.day08.clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private com.example.day08.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        com.example.day08.clusterutil.ui.SquareTextView squareTextView =
                new com.example.day08.clusterutil.ui.SquareTextView(context);
